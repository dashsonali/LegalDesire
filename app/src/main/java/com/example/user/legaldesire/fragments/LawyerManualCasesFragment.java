...
import com.example.user.legaldesire.adapters.CasesAdapter;
...
public class LawyerManualCasesFragment extends Fragment {
    ...
    public void loadRecyclerView(){
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Lawyers").child(FirebaseAuth.getInstance().getCurrentUser().getEmail()
        .replace(".",","));

...
public class PlaceAutocompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Log.e("r", "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            Log.i("r", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            Log.e("r", "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}